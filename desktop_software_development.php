...
$result=mysqli_query($con,"select * from freelancers where sub_category='Desktop & Software Development' && status='approved'");
...
echo"<img src='$r[pic]' class='img-thumbnail profile' style='border-radius:50%;border:8px solid #204353''>";
echo"<div style='text-align:center'>".$r['fname']."</div>";
echo"<div style='text-align:center'>".$r['expertise']."</div>";
