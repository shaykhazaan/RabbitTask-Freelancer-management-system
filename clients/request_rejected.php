...
<body>
	<div id="rest_section">
			...
			<div class="container">
				...
				<h1 class="" style="text-align:center;margin-bottom: 20px;">Rejected Requests</h1>
				<?php
				require_once('../admin/connectivity.php');
				$result=mysqli_query($con,"select * from bid left join freelancers ON bid.freelancer_id=freelancers.fid left join job_post ON bid.job_id=job_post.pid where bid.job_approval='cancel' && bid.client_id=".$_SESSION['clientid']);
